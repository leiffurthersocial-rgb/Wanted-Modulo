...
const DAY_BG = new THREE.Color('#bfe3ff')
...
export function Environment() {
  ...
  useFrame(() => {
    ...
    if (hemiRef.current) hemiRef.current.intensity = 0.7 + dayFactor * 1.0
    if (ambientRef.current) ambientRef.current.intensity = 0.4 + dayFactor * 0.35
